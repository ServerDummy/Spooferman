  ...
  try:
    ...
    while True:
      ...
      for address, _, dat, src in can_recv:
        ...
        print(f"Message Counts... Bus 0: {bus0_msg_cnt} Bus 1: {bus1_msg_cnt} Bus 2: {bus2_msg_cnt} gmlan: balls", end='\r')

  except KeyboardInterrupt:
    print(f"\nNow exiting. Final message Counts... Bus 0: {bus0_msg_cnt} Bus 1: {bus1_msg_cnt} Bus 2: {bus2_msg_cnt} gmlan: balls")
    outputfile.close()
